...
/**
 * Returns a plugin that will parse the HTTP request body if the contentType is
...
function fieldedTextParser(options) {
    ...
    function parseFieldedText(req, res, next) {
        ...
        if (contentType !== 'text/csv' && contentType !== 'text/tsv' && contentType !== 'text/tab-separated-values'
            || !req.body) {
            next();
            return;
        }
